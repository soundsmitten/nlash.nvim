...
--},
  ...
  -- NOTE: The import below can automatically add your own plugins, configuration, etc from `lua/nlash/plugins/*.lua`
  --    This is the easiest way to modularize your config.
  --
  --  Uncomment the following line and add your plugins to `lua/nlash/plugins/*.lua` to get going.
  --    For additional information, see `:help lazy.nvim-lazy.nvim-structuring-your-plugins`
  { import = 'nlash.plugins' },
}, {
  ui = {
